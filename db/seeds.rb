...
pro.default_image = get_file('t20p.jpg')
pro.save!
...
pro.default_image = get_file('t22p.jpg')
pro.save!
...
pro.default_image = get_file('t26p.jpg')
pro.save!
...
pro.default_image = get_file('t46gn.jpg')
pro.save!
...
pro.default_image = get_file('snom-870-grey.jpg')
pro.save!
...
v1.default_image = get_file('snom-870-grey.jpg')
v1.save!
...
v2.default_image = get_file('snom-870-blk.jpg')
v2.save!
...
pro.default_image = get_file('yhs32.jpg')
pro.save!
pro.product_attributes.create!(:key => 'Manufacturer', :value => 'Yealink', :position => 1)
...
pro.default_image = get_file('snom-mm2.jpg')
pro.save!
...
pro.default_image = get_file('w52p.jpg')
pro.save!
pro.stock_level_adjustments.create(:description => 'Initial Stock', :adjustment => 10)
pro.product_attributes.create!(:key => 'Manufacturer', :value => 'Snom', :position => 1)
